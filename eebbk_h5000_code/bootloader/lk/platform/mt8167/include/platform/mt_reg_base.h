...
// MIPI TX Config
#define MIPI_TX_CONFIG_BASE	(0x14018000)

#define DPI1_BASE (0x14019000)

// APB Module lvds analog
#define LVDS_ANA_BASE (0x14018800)
#define LVDS_TX_BASE (0x1401A200)
...
#ifdef MACH_FPGA
#define COMMANDLINE_TO_KERNEL  "console=ttyS0,921600n1 console=ttyMT1,921600n1 earlycon=uart8250,mmio32,0x11006000 root=/dev/ram androidboot.hardware=mt8167"
#else
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 earlycon=uart8250,mmio32,0x11005000 root=/dev/ram vmalloc=496M androidboot.hardware=mt8167"
#endif
