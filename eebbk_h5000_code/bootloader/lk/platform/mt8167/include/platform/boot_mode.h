...
typedef struct {
	...
	u32 lastpc[4][8];
	char pl_version[8];
	struct boot_tag_dram_info dram_info;
} BOOT_ARGUMENT;
...
#define BOOT_TAG_LASTPC		0x88610013
...
#define BOOT_TAG_DRAM_INFO   0x88610015
#if 0
struct boot_tag_dram_info {
	u32 dram_manid;
	u32 dram_size;
