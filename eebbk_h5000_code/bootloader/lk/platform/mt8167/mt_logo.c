...
void mt_disp_show_boot_logo(void)
{
    ...
    else
    {
        ...
        fill_animation_logo(BBK_KEY_BOOT_LOGO_INDEX, mt_get_fb_addr(), (void *)mt_get_tempfb_addr(), logo_addr, phical_screen);
...
void mt_disp_enter_charging_state(void)
{
    ...
    {
        init_fb_screen();
        fill_animation_logo(BBK_USB_BOOT_LOGO_INDEX, mt_get_fb_addr(), (void *)mt_get_tempfb_addr(), logo_addr, phical_screen);
        mt_disp_update(0, 0, CFG_DISPLAY_WIDTH, CFG_DISPLAY_HEIGHT);
...
void mt_disp_show_low_battery(void)
{
    ...
    else
    {
        ...
        fill_animation_logo(BBK_LOW_BATTERY_INDEX, mt_get_fb_addr(), (void *)mt_get_tempfb_addr(), logo_addr, phical_screen);
        mt_disp_update(0, 0, CFG_DISPLAY_WIDTH, CFG_DISPLAY_HEIGHT);
    }
