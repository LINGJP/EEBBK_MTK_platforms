...
{
	mt6392_upmu_set_rg_usbdl_set(0);		/*force leave USBDL mode*/
	mt6392_upmu_set_rg_usbdl_rst(1);		/*force leave USBDL mode*/
	mt6392_upmu_set_rg_ulc_det_en(1);		/*RG_ULC_DET_EN=1*/
}
...
{
	int chr_vol = 0;
	chr_vol = PMIC_IMM_GetOneChannelValue(VCHARGER_CHANNEL_NUMBER,times,1);
	chr_vol = (((R_CHARGER_1+R_CHARGER_2)*100*chr_vol)/R_CHARGER_2) / 100;
