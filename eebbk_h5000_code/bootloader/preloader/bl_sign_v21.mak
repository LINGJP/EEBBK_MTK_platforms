...
ifneq (,$(findstring pss,$(PADDING_TYPE)))
	@echo "padding = pss"
	python $(PBP_TOOL) -i $(CHIP_KEY) -g $(GFH_PATH)/pl_gfh_config_pss.ini -func sign -o $@  $(D_BIN)/$(PL_IMAGE_NAME)_NO_GFH.bin
endif
ifneq (,$(findstring legacy,$(PADDING_TYPE)))
	@echo "padding = legacy"
	python $(PBP_TOOL) -i $(CHIP_KEY) -g $(GFH_PATH)/GFH_CONFIG.ini -func sign -o $@  $(D_BIN)/$(PL_IMAGE_NAME)_NO_GFH.bin
endif
	@echo "$(PBP_TOOL) pass !!!!"
