...
void Set_MRR_Pinmux_Mapping(DRAMC_CTX_T *p)
{
    ...
    {
     	uiLPDDR_MRR_Mapping = (U32 *)uiDDR_PHY_Mapping[(U8)(p->pinmux)];
    }
    else
    {
    	return;
...
void DDRPhyPLLSetting_MT8167(DRAMC_CTX_T *p)
{
    ...
    if(p->frequency==DDR_DDR1066) //1066
    {
    ...
    {
        vIO32WriteFldMulti(DDRPHY_SHU1_PLL5, P_Fld(1, SHU1_PLL5_RG_RPHYPLL_SDM_PCW_CHG)
                | P_Fld(0x3b000000, SHU1_PLL5_RG_RPHYPLL_SDM_PCW));
        vIO32WriteFldMulti(DDRPHY_SHU1_PLL7, P_Fld(1, SHU1_PLL7_RG_RCLRPLL_SDM_PCW_CHG)
                | P_Fld(0x20000000, SHU1_PLL7_RG_RCLRPLL_SDM_PCW));
        if (p->ssc_en == ENABLE)
        {
...
static DRAM_STATUS_T DefaultSettings_LPDDR3(DRAMC_CTX_T *p)
{
	//TX CMD 2T
...
static DRAM_STATUS_T DramcSetting_ACTiming_PC3(DRAMC_CTX_T *p)
{
    ...
    vIO32WriteFldMulti(DRAMC_REG_SHU_ACTIM4, P_Fld(0x1E, SHU_ACTIM4_TZQCS)
        			...
        			| P_Fld(0x56, SHU_ACTIM4_TXREFCNT));	
...
static DRAM_STATUS_T DramcSetting_Default_PC4(DRAMC_CTX_T *p)
{
...
static DRAM_STATUS_T DramcSetting_ACTiming_PC4(DRAMC_CTX_T *p)
{
