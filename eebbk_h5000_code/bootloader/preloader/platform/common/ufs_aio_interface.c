...
{
#ifdef MTK_UFS_PLATFORM_ELBRUS

	/*
	 * Elbrus
	 * Temporary Solution: Use eMCP's DRAM setting for UFS project.
	 */

	/* {0x90,0x01,0x4A,0x48,0x42,0x47,0x38,0x61,0x34,0x0,0x0,0x0,0x0,0x0,0x0,0x0} */
	id[0] = 0x90;
	id[1] = 0x01;
	id[2] = 0x4A;
	id[3] = 0x48;
...
(unsigned long blkaddr, u32 blkcnt, void* buf) {
