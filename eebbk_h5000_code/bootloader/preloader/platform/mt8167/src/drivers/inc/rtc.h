...
#define RTC_NONE                (0x00)
#define RTC_ALARM               (0x01)
#define RTC_REBOOT_RECOVERY     (0x02)
#define RTC_REBOOT_BOOTLOADER   (0x04)
#define RTC_KERNEL_PANIC        (0x08)
#define RTC_KERNEL_RESTART      (0x10)
#define RTC_KERNEL_AEE          (0x20)
...
extern int rtc_boot_check(void);
