...
int ufs_aio_otp_lock_req(char *otp_part_name)
{
	...
	part_otp = mt_part_get_partition(otp_part_name);
	...
	ret = ufs_aio_block_read(UFS_DEFAULT_HOST_ID, (u32)ufs_switch_part(UFS_LU_USER), blk_start, 1, buf);
